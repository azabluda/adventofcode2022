...
int Prio(IEnumerable<IEnumerable<char>> chunks) =>
    " abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"
        .IndexOf(chunks.Aggregate(Enumerable.Intersect).Single());

foreach (var data in TestData()) {
    var sacks = data.Split("\r\n");
    var part1 = sacks.Select(s => s.Chunk(s.Length / 2)).Sum(Prio);
    var part2 = sacks.Chunk(3).Sum(Prio);
